...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { done: @deal.done, photo: @deal.photo, title: @deal.title, user_id: @deal.user_id } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { done: @deal.done, photo: @deal.photo, title: @deal.title, user_id: @deal.user_id } }
